              ...
              <div>
                <div className="container1">
                  <StyledFigure>
                    ...
                    <Headline>Hello, my name is <StyledSpanPink>Christiane Yamate</StyledSpanPink></Headline>
                </div>
                  ...
                  <div className="container4">
                    <a href="#project" > <StyledBtnBlue>See Projects</StyledBtnBlue></a>
                    <a href="https://github.com/christianeyamate"target="_blank"><IoLogoGithub size={50} color="F8F9FA"/></a>
                  </div>
                  <StyleUl>
